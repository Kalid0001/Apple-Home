...
function Footer() {
  const toggle = (e) => {
    ...
    console.log(target);
    if (target.classList.contains("reveal-urls")) {
      target.classList.remove("reveal-urls");
    } else {
      target.classList.add("reveal-urls");
    }
  };
  return (
        ...
        <div className="footer-links-wrapper row">
          <div className="links-wrapper-1 col-sm-12 col-md">
            <div className="link-header-wrapper">
              ...
              <FaPlus className="toggler" display="none" onClick={toggle} />
            </div>
          ...
          <div className="links-wrapper-9 col-sm-12 col-md">
            <div className="link-header-wrapper">
              <h3>Apple Values</h3>
              <FaPlus className="toggler" display="none" onClick={toggle} />
            </div>
